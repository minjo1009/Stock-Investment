...
DEFAULT_REQUEST_SLEEP_SEC = 0.35
...
class AlpacaHistoricalMicrostructureProvider:
    def __init__(
        ...
        *,
        ...
        request_sleep_sec: float = DEFAULT_REQUEST_SLEEP_SEC,
        ...
        self.request_sleep_sec = float(request_sleep_sec)
