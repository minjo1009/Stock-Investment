...
CADENCE_SPECS = [
    ...
    {
        "job_name": "official_public_releases_refresh",
        ...
        "requires_lineage": 1,
        "downstream_blocker": 1,
        "owner": "Data Operations / News Source Governance",
        "provider_owner": "official RSS/API public releases",
        "run_boundary": "DIAGNOSTIC_ONLY",
        "freshness_basis": "official publication timestamp",
        "notes": "disabled by default until provider allowlist and source-time certification are operator-enabled; scheduler config posture is 30m conservative",
    },
    {
        "job_name": "gdelt_news_events_refresh",
        ...
        "owner": "Data Operations / News Source Governance",
        "provider_owner": "GDELT DOC API discovery metadata",
        "run_boundary": "DIAGNOSTIC_ONLY",
        "freshness_basis": "GDELT seen date or article publication timestamp",
        "notes": "disabled by default; discovery source only and not strict authority for original article truth",
    },
    {
        "job_name": "marketaux_news_free_refresh",
        ...
        "downstream_blocker": 0,
        "owner": "Data Operations / News Source Governance",
        "provider_owner": "Marketaux free API metadata",
        "run_boundary": "DIAGNOSTIC_ONLY",
        "freshness_basis": "provider published_at timestamp",
        "notes": "disabled by default until API token, quota, and license posture are operator-confirmed; scheduler config posture is 60m token-gated",
    },
    {
