...
Archive relocation is blocked until referenced candidates have a dependency-aware migration plan. A005 also found 1262 `NEEDS_REVIEW` files and 2147 archive-review files. A006 completed the generated-cache DELETE_SAFE pass; non-cache cleanup still requires owner or migration review.
