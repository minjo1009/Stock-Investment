...
| Data / DB / Scheduler | Data & Market Microstructure | Research Governance | `docs/architecture/l0_source_acquisition_project_management_plan.md`, scheduler config, readiness registry, source reports, DB/source contracts | Do not approximate missing raw sources or treat scheduler enablement as trading permission. |
