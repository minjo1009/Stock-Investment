...
- `docs/archive/external_context/참고 Context/` holds large external source trees under the same root as active code/artifacts.
...
- move/alias `docs/archive/external_context/참고 Context/` under a clearly non-runtime path (e.g., `references/`).
