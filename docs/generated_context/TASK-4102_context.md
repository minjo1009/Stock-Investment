...
|---|---:|---:|---|
| .codex/skills/l4-thesis-bundle/SKILL.md | 654 | 163 | must_include |
| AGENTS.md | 1380 | 345 | must_include |
| docs/reports/task_4102_l4_profile_validator_hardening/report.md | 1154 | 288 | optional_include |
...
## File: .codex/skills/l4-thesis-bundle/SKILL.md

```md
# L4 Thesis Bundle Skill

Use this skill to construct and validate thesis bundles at institutional quality.

Profile:
- `L4_THESIS_BUNDLE` in `ops/task_profiles.yaml`

Hard forbidden actions:
- no final policy action
- no broker mutation
- no live order
- no real capital
- no paper promotion
- missing or stale data must be UNKNOWN/BLOCKER
...
## File: docs/reports/task_4102_l4_profile_validator_hardening/report.md
