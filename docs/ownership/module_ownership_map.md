...
## Persistent GPT/Chrome Review Subagent

Task606 adds `skills/gpt-chrome-review-subagent/SKILL.md` as the persistent review-subagent workflow for GPT/Chrome use.
...
Every lane must use a packet generated by `skills/gpt-chrome-review-subagent/scripts/new_review_packet.py` before GPT/Chrome findings affect repo work.
