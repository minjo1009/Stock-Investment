...
- task_id: `task_737_semantic_modifier_bundle_attachment`
- review_date: `2026-06-10`
- lane: `strategy`
- objective: Institutional design for attaching Task736 semantic translations into candidate bundles as confidence, risk, slot, and research modifiers without creating direct buy/sell actionability
...
- src/backtest/context_semantic_translator.py

## Validation Commands To Preserve

- python src/backtest/build_task737_semantic_modifier_bundle_attachment.py
- python -m unittest tests.test_task737_semantic_modifier_bundle_attachment
