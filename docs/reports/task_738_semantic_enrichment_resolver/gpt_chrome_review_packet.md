...
- task_id: `task_738_semantic_enrichment_resolver`
- review_date: `2026-06-10`
- lane: `strategy`
- objective: Institutional design for resolving Task737 semantic_enrichment_needed bundles by circuit-specific missing primitive requirements and next extractor contracts without using outcomes or creating buy/sell actionability
...
- src/backtest/semantic_modifier_bundle_attachment.py

## Validation Commands To Preserve

- python src/backtest/build_task738_semantic_enrichment_resolver.py
- python -m unittest tests.test_task738_semantic_enrichment_resolver
