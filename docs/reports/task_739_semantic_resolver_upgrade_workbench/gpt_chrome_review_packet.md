...
- task_id: `task_739_semantic_resolver_upgrade_workbench`
- review_date: `2026-06-10`
- lane: `strategy`
- objective: Institutional review for converting Task738 enrichment requirements into circuit-specific extractor and resolver upgrade work orders without trading, scoring, ranking, or backtest
...
- python src/backtest/build_task739_semantic_resolver_upgrade_workbench.py
- python -m unittest tests.test_task739_semantic_resolver_upgrade_workbench
