Use Pro-level reasoning. Do not use GitHub. Do not inspect minjo1009/Stock-Investment on GitHub because the relevant L0/L1 work is local and not committed. Use only the local context packet below.
