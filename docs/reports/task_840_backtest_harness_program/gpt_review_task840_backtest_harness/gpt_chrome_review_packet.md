...
- task_id: `gpt_review_task840_backtest_harness`
- review_date: `2026-06-13`
- lane: `backtest`
- objective: Review no-execution backtest harness discipline for leakage, overclaim, and premature replay risk
...
- docs/reports/task_840_backtest_harness_program
