...
- Fresh baseline candidates: 5041, avg return 8.62%, entry-reduce failure 35.13%.
- Fresh TurboQuant trades: 735, avg return 13.92%, delta 5.30pp.
...
|---|---:|---:|---:|---:|
| `fresh_baseline_all_candidates` | 5041 | 8.62% | 59.10% | 35.13% |
| `fresh_turboquant_strategy` | 735 | 13.92% | 65.31% | 31.70% |

### Split Summary

| Split | Count | Avg Return | Win | Entry-Reduce | Positive |
|---|---:|---:|---:|---:|---:|
| `train_design` | 364 | 20.53% | 76.65% | 21.43% | 1 |
| `validation` | 262 | 9.63% | 62.98% | 33.97% | 1 |
| `recent_oos` | 109 | 2.17% | 33.03% | 60.55% | 0 |

### Pass/Fail Matrix

| Gate | Pass | Observed | Required |
|---|---:|---|---|
| `fresh_candidate_generation` | 1 | baseline_candidates=5041 | >=300 fresh raw-generated candidates |
| `fresh_strategy_diagnostic_performance` | 1 | strategy_count=735; strategy_avg=13.92%; baseline_avg=8.62%; strategy_entry_reduce=31.70%; baseline_entry_reduce=35.13% | count>=50; avg return >= baseline+2pp; entry_reduce <= baseline |
