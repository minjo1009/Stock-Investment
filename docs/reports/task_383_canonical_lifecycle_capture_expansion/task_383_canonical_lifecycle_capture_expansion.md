...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| COMPLETE_PASS | NOT_VALIDATED_CANONICAL_EVIDENCE_ACCUMULATION | 0 | 0 | 431 | 0 | 0 | NO_CAPTURE_EXPANSION_REQUIRED | 0 | 0 | 0 | collect_canonical_lifecycle_stream |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 0 | 0 | 0 | 0 | 0 | 0 | collect_canonical_lifecycle_stream | 0 | 0 | 0 |
